...
soccer_ball = Item(name="Soccer ball",
                   description="""An ideal ball for players taking their first
                               steps onto the pitch, the Soccer Ball is a
                               solid, durable go-to that handles the rigors of
                               tough shooting and skill drills while
                               celebrating the sport's iconic tournament.""",
                   time_updated=dt.now(),
                   category=soccer,
                   user=user1)

goalie_shoes = Item(name="Goalkeeper Gloves",
                    description="""Equipped with a smooth latex foam palm, the
                                Nike Adult Match Goalkeeper Soccer Goalie
                                Gloves offer reliable impact protection and
                                consistent grip so you can block the hardest
                                shots in any weather conditions.""",
                    time_updated=dt.now(),
                    category=soccer,
                    user=user1)
...
basket_ball = Item(name="A pretty good basketball",
                   description="An all-in-one package that includes an\
                               easy-to-use air pump to maintain the perfect\
                               inflation",
                   time_updated=dt.now(),
                   category=basketball,
                   user=user1)
...
snowboard = Item(name="Concrete snowboard",
                 description="An excessively heavy snowboard. Easy to stand\
                             on, not very useful in any other situation",
                 time_updated=dt.now(),
...
gopro = Item(name="GoPro camera",
             description="Because it didn't happen if you don't have the video.\
                         All your friends LOVE to watch the tip of your\
                         snowboard for three hours",
             time_updated=dt.now(),
             category=snowboarding,
             user=user1)
...
hockey_stick = Item(name="Hockey stick",
                    description="Perfect for pushing around a puck and\
                                fighting.",
                    time_updated=dt.now(),
                    category=hockey,
                    user=user1)
